...
const About = () => {
    ...
    useEffect(() => {
        ...
        // Add CSS styles to the body
        const style = document.createElement('style');
        style.innerHTML = `
    body {
        box-sizing: inherit;
        background-image: url('https://raw.githubusercontent.com/taroj1205/taroj1205.github.io/main/thumbnail.png');
...
`;
    ...
    return (
        <main className="about container mx-auto py-10 max-w-6xl text-white bg-zinc-950 font-sans text-base">
            <img
                className="pfp rounded-full w-40 mx-auto"
                src="https://raw.githubusercontent.com/taroj1205/taroj1205.github.io/main/pfp.png"
                alt="Profile Picture"
            />
            <h1 className="text-4xl text-center mt-8">{t('about.title')}</h1>
