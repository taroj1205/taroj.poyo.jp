                            ...
                            <div className="w-96 bg-white p-4 rounded-lg shadow-lg dark:bg-gray-800">
                                ...
                                <form className="flex items-center" onSubmit={handleUrlSubmit}>
                                    <input
                                        ...
                                        className="flex-grow border-none rounded-lg shadow-sm text-black dark:text-white focus:ring bg-gray-200 focus:ring-blue-200 h-9 dark:bg-gray-900 dark:border-gray-600"
                                    />
                                    <button
                                        type="submit"
                                        aria-label='change'
