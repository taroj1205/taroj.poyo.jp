...
export function getThemeOptions(t: ReturnType<typeof useTranslation>['t']): readonly ThemeOption[] {
    return [
        { value: 'dark', label: t('theme.dark'), color: '#333' },
        { value: 'light', label: t('theme.light'), color: '#f4f4f4' },
    ];
}
