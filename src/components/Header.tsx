...
const Header = () => {
    ...
    const headerPosition = isChatPage ? 'sticky' : 'fixed';

    return (
        <header className={`${headerPosition} top-0 left-0 z-[100] whitespace-nowrap w-full bg-white dark:bg-slate-900 shadow-xl transition-all duration-350 ease`}>
            {/* <Announcement /> */}
